...
router.put('/:id', function(req, res) {
    pg.connect(db_url, function(err, client, done) {
        ...
        client.query('UPDATE kittens SET name = $1 WHERE id = $2', [req.body.kittens.name, req.params.id], function(err, data) {
            if (err) {
                return console.error('error querying database', err);
            }
            res.redirect('/kittens');
...
module.exports = router; //this is the middleware that is exported into the app.js
